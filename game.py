...
def collision(car, pattern): # Function for collision of car and obstacle
	
	collision_status = False

	for obstacle in pattern.obstacles: # Iterates over list of obstacles in a pattern to see which if one collided with car
